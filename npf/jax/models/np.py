...
class NPBase(LatentNPF):
    ...
    def _predict(self,
        ...
        # Encode
        z_i_ctx, r_i_ctx = self._encode(x_ctx, y_ctx, mask_ctx)                 # [batch, ctx, z_dim], [batch, ctx, r_dim]
    ...
    def vi_loss(self,
        ...
        z_i_tar = self._encode(x_tar, y_tar, mask_tar, latent_only=True)        # [batch, target, z_dim]
